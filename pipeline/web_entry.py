...
from .web_server import SecureHandler


class FinalHandler(SecureHandler):
    """Final NAS Web handler: authenticated exposure plus typed destructive confirmation."""
...
def make_server(
    ...
    *,
    ...
    handler = type("BoundFinalHandler", (FinalHandler,), {"app": app})
